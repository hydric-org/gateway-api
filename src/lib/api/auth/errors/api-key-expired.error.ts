import { ApiKeyExpiredMetadata } from '@lib/api/error/dtos/metadata/api-key-expired-metadata.dto';
...
export class ApiKeyExpiredError extends BaseApiError<ApiKeyExpiredMetadata> {
  constructor(params: { expiredAt: string }) {
    super({
      ...
      metadata: { expiredAt: params.expiredAt },
    });
  }
}
