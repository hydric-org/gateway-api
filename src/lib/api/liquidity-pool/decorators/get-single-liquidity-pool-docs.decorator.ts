...
import { SuccessResponse } from '@lib/api/success/dtos/success-response.dto';
...
export function GetSingleLiquidityPoolDocs() {
  return applyDecorators(
    ...
    ApiExtraModels(SuccessResponse, GetSingleLiquidityPoolResponse, LiquidityPool),
    ApiOkResponse({
      ...
      examples: {
        V3: {
          ...
          value: SuccessResponse.from({ pool: V3LiquidityPoolExample }, '/pools/v1/8453/0x...'),
        },
        V4: {
          summary: 'Liquidity pool with V4 metadata',
          value: SuccessResponse.from({ pool: V4LiquidityPoolExample }, '/pools/v1/8453/0x...'),
        },
      },
    }),
